...
func init() {
	ttnpb.AddSelectFlagsForApplicationPackageAssociation(selectApplicationPackageAssociationsFlags, "")
	ttnpb.AddSelectFlagsForApplicationPackageDefaultAssociation(selectApplicationPackageDefaultAssociationsFlags, "")
	...
	ttnpb.AddSetFlagsForApplicationPackageAssociation(applicationsPackageAssociationSetCommand.Flags(), "")
	flagsplugin.AddAlias(applicationsPackageAssociationSetCommand.Flags(), "ids.end-device-ids.application-ids.application-id", "application-id")
	flagsplugin.AddAlias(applicationsPackageAssociationSetCommand.Flags(), "ids.end-device-ids.device-id", "device-id")
	flagsplugin.AddAlias(applicationsPackageAssociationSetCommand.Flags(), "ids.f-port", "f-port")
	...
	ttnpb.AddSetFlagsForApplicationPackageDefaultAssociation(applicationsPackageDefaultAssociationSetCommand.Flags(), "")
	flagsplugin.AddAlias(applicationsPackageDefaultAssociationSetCommand.Flags(), "ids.application-ids.application-id", "application-id")
	flagsplugin.AddAlias(applicationsPackageDefaultAssociationSetCommand.Flags(), "ids.f-port", "f-port")
