...
func init() {
	...
	flagsplugin.AddAlias(organizationsCreateCommand.Flags(), "ids.organization-id", "organization-id", false)
	ttnpb.AddSetFlagsForUserIdentifiers(organizationsCreateCommand.Flags(), "", false)
	...
	flagsplugin.AddAlias(organizationsSetCommand.Flags(), "ids.organization-id", "organization-id", false)
