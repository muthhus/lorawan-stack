...
func init() {
	ttnpb.AddSelectFlagsForOrganization(selectOrganizationFlags, "")
	ttnpb.AddSetFlagsForListOrganizationsRequest(organizationsListCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForSearchOrganizationsRequest(organizationsSearchCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForOrganization(organizationsCreateCommand.Flags(), "")
	flagsplugin.AddAlias(organizationsCreateCommand.Flags(), "ids.organization-id", "organization-id")
	ttnpb.AddSetFlagsForUserIdentifiers(organizationsCreateCommand.Flags(), "")
	organizationsCommand.AddCommand(organizationsCreateCommand)
	ttnpb.AddSetFlagsForOrganization(organizationsSetCommand.Flags(), "")
	flagsplugin.AddAlias(organizationsSetCommand.Flags(), "ids.organization-id", "organization-id")
