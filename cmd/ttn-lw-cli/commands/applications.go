...
func init() {
	ttnpb.AddSelectFlagsForApplication(selectApplicationFlags, "")
	ttnpb.AddSetFlagsForListApplicationsRequest(applicationsListCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForSearchApplicationsRequest(applicationsSearchCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForApplication(applicationsCreateCommand.Flags(), "")
	flagsplugin.AddAlias(applicationsCreateCommand.Flags(), "ids.application-id", "application-id")
	ttnpb.AddSetFlagsForOrganizationOrUserIdentifiers(applicationsCreateCommand.Flags(), "")
	AddCollaboratorFlagAlias(applicationsCreateCommand.Flags(), "")
	applicationsCommand.AddCommand(applicationsCreateCommand)
	ttnpb.AddSetFlagsForApplication(applicationsSetCommand.Flags(), "")
	flagsplugin.AddAlias(applicationsSetCommand.Flags(), "ids.application-id", "application-id")
