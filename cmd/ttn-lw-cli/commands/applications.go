...
func init() {
	...
	flagsplugin.AddAlias(applicationsCreateCommand.Flags(), "ids.application-id", "application-id", false)
	ttnpb.AddSetFlagsForOrganizationOrUserIdentifiers(applicationsCreateCommand.Flags(), "", false)
	...
	flagsplugin.AddAlias(applicationsSetCommand.Flags(), "ids.application-id", "application-id", false)
