...
func init() {
	ttnpb.AddSelectFlagsForGateway(selectGatewayFlags, "")
	...
	ttnpb.AddSetFlagsForListGatewaysRequest(gatewaysListCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForSearchGatewaysRequest(gatewaysSearchCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForGateway(gatewaysCreateCommand.Flags(), "")
	ttnpb.AddSetFlagsForOrganizationOrUserIdentifiers(gatewaysCreateCommand.Flags(), "")
	AddCollaboratorFlagAlias(gatewaysCreateCommand.Flags(), "")
	ttnpb.AddSetFlagsForGatewayAntenna(gatewaysCreateCommand.Flags(), "antenna")
	...
	ttnpb.AddSetFlagsForGateway(gatewaysSetCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForGatewayAntenna(gatewaysSetCommand.Flags(), "antenna")
