...
func init() {
	ttnpb.AddSelectFlagsForClient(selectClientFlags, "")
	ttnpb.AddSetFlagsForListClientsRequest(clientsListCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForSearchClientsRequest(clientsSearchCommand.Flags(), "")
	...
	ttnpb.AddSetFlagsForClient(clientsCreateCommand.Flags(), "")
	ttnpb.AddSetFlagsForOrganizationOrUserIdentifiers(clientsCreateCommand.Flags(), "")
	AddCollaboratorFlagAlias(clientsCreateCommand.Flags(), "")
	flagsplugin.AddAlias(clientsCreateCommand.Flags(), "ids.client-id", "client-id")
	...
	ttnpb.AddSetFlagsForClient(clientsSetCommand.Flags(), "")
	flagsplugin.AddAlias(clientsSetCommand.Flags(), "ids.client-id", "client-id")
