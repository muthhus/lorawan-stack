...
func init() {
	...
	ttnpb.AddSetFlagsForOrganizationOrUserIdentifiers(clientsCreateCommand.Flags(), "", false)
	AddCollaboratorFlagAlias(clientsCreateCommand.Flags(), "")
	flagsplugin.AddAlias(clientsCreateCommand.Flags(), "ids.client-id", "client-id", false)
	...
	flagsplugin.AddAlias(clientsSetCommand.Flags(), "ids.client-id", "client-id", false)
