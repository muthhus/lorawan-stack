...
| ----- | ----------- |
| `receiver_ids` | <p>`message.required`: `true`</p> |
| `ids` | <p>`repeated.min_items`: `1000`</p><p>`repeated.max_items`: `1000`</p><p>`repeated.unique`: `true`</p><p>`repeated.items.string.len`: `36`</p> |
...
| `UpdateStatus` | [`UpdateNotificationStatusRequest`](#ttn.lorawan.v3.UpdateNotificationStatusRequest) | [`.google.protobuf.Empty`](#google.protobuf.Empty) | Update the status of notifications. |
...
| `RIGHT_USERS_NOTIFICATIONS_READ` | 59 | The right to read notifications sent to the user. |
