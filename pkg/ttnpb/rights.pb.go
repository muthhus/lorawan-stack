...
const (
	...
	Right_RIGHT_USERS_NOTIFICATIONS_READ Right = 59
...
var Right_name = map[int32]string{
	...
	59: "RIGHT_USERS_NOTIFICATIONS_READ",
	14: "RIGHT_USER_ALL",
...
var Right_value = map[string]int32{
	...
	"RIGHT_USERS_NOTIFICATIONS_READ":           59,
	"RIGHT_USER_ALL":                           14,
...
var fileDescriptor_9bb69af2cf8904c5 = []byte{
	...
	,
}
